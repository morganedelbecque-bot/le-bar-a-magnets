  ...
  return (
    <>
      <section className="relative overflow-hidden">
        <img src={heroImg} alt="Animation anniversaire à Toulouse" className="absolute inset-0 w-full h-full object-cover animate-slow-zoom" />
        <div className="absolute inset-0 bg-black/36" />

        <div className="relative z-10 max-w-6xl mx-auto px-6 py-28 text-center">
          <p className="text-[11px] uppercase tracking-[0.45em] text-[#f6eadb] mb-6 font-medium">Animation anniversaire Toulouse</p>
      ...
      <section className="bg-[#fcf1ec] py-20 px-6 md:px-10">
        <div className="max-w-7xl mx-auto grid gap-12 lg:grid-cols-2 items-start">
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed">Animation modulable selon le thème et le nombre d'invités, parfaite pour anniversaires privés ou soirées corporate à Toulouse.</p>
