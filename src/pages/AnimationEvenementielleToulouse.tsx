    ...
    <>
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-28 text-center">
          <p className="text-[11px] uppercase tracking-[0.45em] text-[#f6eadb] mb-6 font-medium">Animation événementielle Toulouse</p>
          ...
          <p className="mx-auto max-w-3xl text-sm md:text-base text-[#f6eadb] leading-relaxed">Solutions sur-mesure pour soirées d'entreprise, lancements, et événements privés dans la région Toulousaine.</p>
        </div>
      </section>
      ...
      <section className="bg-[#fcf1ec] py-20 px-6 md:px-10">
        <div className="max-w-7xl mx-auto grid gap-12 lg:grid-cols-2 items-start">
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed">Une animation élégante et professionnelle pour vos événements à Toulouse, adaptée aux contraintes d'un événement corporate.</p>
          ...
          <div>
            ...
            <div className="mt-4 space-y-4">
              <details className="bg-white/90 p-4 rounded-[12px] border border-border/30"><summary className="font-medium cursor-pointer">Intervention sur site ?</summary><p className="mt-2 text-foreground/75">Oui, nous intervenons sur Toulouse et région Occitanie.</p></details>
            </div>
          </div>
        </div>
      </section>
